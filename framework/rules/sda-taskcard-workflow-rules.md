---
description: Paths canônicos do framework TaskCard (tasks individuais e task plan agregador). Carregada quando uma skill taskcard-* está ativa. Paths compartilhados de docs/specs são tratados pela rule comum sda-workflow-rules.md (para evitar carregamento cruzado entre os 3 frameworks que dividem o diretório docs/specs).
paths:
...
> Paths compartilhados (pre_refinement, run_report, workflow_report, temp_memory) e Critical Paths estão em `sda-workflow-rules.md`.
