...
## 12. Integração com framework sda

(Aplicável apenas quando invocado dentro do framework SDD/miniSpec/TaskCard.)

- [ ] Path do output respeita `shared.handoff_frontend.path` da `sda-workflow-rules.md` (casos TaskCard/genérico: tabela "Paths" no SKILL.md).
