...
## Taxonomia (use no sda-qa-validator e ci_flakiness reports)
...
Heurística leve para sda-qa-validator detectar flakiness emergente:

- Em tasks que tocam `testes_executados.tocou_area_critica == true`, rodar a suíte **2x** em vez de 1x.
