...
- **Performance/load testing** (k6, Gatling, Locust): coberto parcialmente pelo `sda-qa-test-generator` em "recomendacoes" quando aplicável, mas a doutrina específica de carga ficou fora.
...
- **Acessibilidade automatizada** (axe, Pa11y): mencionada em `sda-qa-test-generator` como categoria, mas a doutrina detalhada (WCAG rule-by-rule) ficou fora.
