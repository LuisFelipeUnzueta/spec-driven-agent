...
> **Contrato de reuso**: o `design.md` de cada feature e os executores referenciam os componentes **por esta tabela** — criar um input/botão/modal novo em vez de usar a referência canônica é desvio (a `sda-generate-design` exige justificativa + candidatura ao global para componente novo).
